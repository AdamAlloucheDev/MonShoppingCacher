...
return [
    ...
    'customer' => [
        ...
        'account' => [
            ...
            'wishlist' => [
                'page-title' => 'Liste de courses',
                'title' => 'Liste de courses',
                'deleteall' => 'Tout supprimer',
                'moveall' => 'Déplacer tous les produits vers le panier',
                'move-to-cart' => 'Passer au panier',
                'error' => 'Impossible d\'ajouter le produit à la liste de courses en raison de problèmes inconnus, veuillez vérifier plus tard',
                'add' => 'Article ajouté avec succès à la liste de courses',
                'remove' => 'Article supprimé avec succès de la liste de courses',
                ...
                'option-missing' => 'Les options du produit sont manquantes, l\'article ne peut donc pas être déplacé vers la liste de courses.',
                'move-error' => 'L\'article ne peut pas être déplacé vers la liste de courses, veuillez réessayer plus tard',
                'success' => 'Article ajouté avec succès à la liste de courses',
                'failure' => 'L\'article ne peut pas être ajouté à la liste de courses, veuillez réessayer plus tard',
                'already' => 'Article déjà présent dans votre wishlist',
                'removed' => 'Article supprimé avec succès de la liste de courses',
                'remove-fail' => 'L\'article ne peut pas être supprimé de la liste de courses, veuillez réessayer plus tard',
                'empty' => 'Vous n\'avez aucun article dans votre liste de courses',
    ...
    'products' => [
        ...
        'wishlist-options' => 'Options de liste de courses',
    ...
    'checkout' => [
        'cart' => [
            ...
            'move-to-wishlist' => 'Placer dans la liste de courses',
            'move-to-wishlist-success' => 'L\'article a été déplacé vers la liste de courses avec succès.',
            'move-to-wishlist-error' => 'Impossible de déplacer l\'élément vers la liste de courses, veuillez réessayer plus tard.',
