...
return [
    'admin' => [
        ...
        'contents' => [
            ...
            'content' => [
                ...
                'custom-product' => 'Produits Spéciaux',
    ...
    'home' => [
        ...
        'hot-categories' => 'Catégories tendances',
    ...
    'header' => [
        ...
        'dropdown-text' => 'Gérer le panier, les commandes et la liste de courses',
    ],

    'menu-navbar' => [
        'text-more' => 'Suite',
        'text-category' => 'Catégories',
    ],
    ...
    'customer' => [
        ...
        'wishlist' => [
            'remove-all-success' => 'Tous les articles de votre liste de courses ont été supprimés',
        ],
    ],
    ...
    'shop' => [
        ...
        'wishlist' => [
            'add-wishlist-text' => 'Ajouter un produit à la liste de courses',
            'remove-wishlist-text' => 'Supprimer le produit de la liste de courses',
        ],
